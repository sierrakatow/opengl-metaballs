...
const VertexFormat VertexPNC::FORMAT = VertexFormat(sizeof(VertexPNC))
                                       .put("aPosition", 3, GL_FLOAT, GL_FALSE, offsetof(VertexPNC, p))
                                       .put("aNormal", 3, GL_FLOAT, GL_FALSE, offsetof(VertexPNC, n))
                                       .put("aColor", 2, GL_FLOAT, GL_FALSE, offsetof(VertexPNC, c));
